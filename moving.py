...
async def run():
    ...
    # await drone.offboard.set_position_ned(PositionNedYaw(0, 5, -5, 0.0))
    # await drone.offboard.set_position_ned(PositionNedYaw(0, 5, -5, 0.0))


    await drone.offboard.set_position_ned(PositionNedYaw(-28.26, -27.91, -13, 0.0))

    # await drone.offboard.set_position_ned(PositionNedYaw(-36.70, -20.72, -10, 0.0))
